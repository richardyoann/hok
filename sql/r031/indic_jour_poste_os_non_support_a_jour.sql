...
where kvhrb."SupportEndDateAsDate"<now()::date and kvhrb."SupportEndDateAsDate" notnull and viws.summarization =3
 ) 
select
	'Nb postes os non supporté a jour' as indicateur,
