...
where kvhrb."SupportEndDateAsDate"<now()::date and kvhrb."SupportEndDateAsDate" notnull and (viws.summarization =2 or viws.summarization =4)  
 ) 
select
	'Nb postes os non supporté en erreur' as indicateur,
	'Nb postes os non supporté' as indicateur_parent,
