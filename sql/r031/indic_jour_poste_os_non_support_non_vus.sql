...
where kvhrb."SupportEndDateAsDate"<now()::date and kvhrb."SupportEndDateAsDate" notnull and viws.summarization =8
 ) 
select
	'Nb postes os non supporté non vus' as indicateur,
