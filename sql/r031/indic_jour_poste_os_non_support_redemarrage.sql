...
where kvhrb."SupportEndDateAsDate"<now()::date and kvhrb."SupportEndDateAsDate" notnull and viws.summarization =5
 ) 
select
	'Nb postes os non supporté attente redémarrage' as indicateur,
