...
-- Requête principale pour obtenir les statistiques de déploiement des postes ayant réussi le patching
SELECT
    pc.campagne || ' - ' || pc.historisation  ||' -Poste' AS indicateur,
	...
	-- Count le nombre de pc ayant réussi le patching
