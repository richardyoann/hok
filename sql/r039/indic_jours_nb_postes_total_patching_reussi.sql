...
-- Requête principale pour obtenir les statistiques de déploiement vu dans le parc
SELECT
    pc.campagne || ' - ' || pc.historisation  ||' -Total' AS indicateur,
    pc.campagne || ' - ' || pc.historisation  ||' -Total'  AS indicateur_parent,
